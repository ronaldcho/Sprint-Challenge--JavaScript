...
const uni = [];
for (let i = 0; i < graduates.length; i++) {
  // console.log((graduates[i].university).includes("Uni"));
  if (graduates[i].university.includes('Uni')) {
    uni.push(graduates[i].university);
  }
}
console.log("############## 'Uni' string Universities name  #################");
console.log(uni);
...
const animalNames = [];
//   Object.keys(zooAnimals).forEach(function(key) {
//     animalNames.push(key + ': ' + zooAnimals[key]);
// });
zooAnimals.forEach(key => {
  animalNames.push(`Name: ${key.animal_name}  Scientific: ${key.scientific_name}`);
});
console.log('######### Animal name & Scientific name  #############');
console.log(animalNames);
...
const lowerCase = [];
zooAnimals.map(key => {
  lowerCase.push(key.animal_name.toLowerCase());
});
console.log('######### Animal name to lower case  #############');
console.log(lowerCase);
...
const largerPopulation = zooAnimals.filter(key => key.population < 5);
console.log('######### Animal lower population < 5 count  #############');
console.log(largerPopulation);
/* 
